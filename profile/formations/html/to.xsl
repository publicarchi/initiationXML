<xsl:stylesheet xmlns:tei="http://www.tei-c.org/ns/1.0"
  ...
  <xsl:import href="/Users/emmanuelchateau/TEIC/Stylesheets/html/html.xsl"/>

  <xsl:param name="cssFileInclude">true</xsl:param>
  <xsl:param name="cssFile" as="xs:string">style.css</xsl:param>
  <xsl:param name="tocDepth">1</xsl:param>
  <xsl:param name="institution">Publicarchitectura</xsl:param>
